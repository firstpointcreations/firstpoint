...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from collcategory where id='$id'");
?>
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Work Category </li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Work Category </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="col-md-10 col-md-offset-1">
            
              <form class="form-horizontal" method="post" action="update-collectioncategory.php?id=<?php echo $row['id'];?>" name="gallerycategory" enctype="multipart/form-data">
              
              <div class="msgpass"><?php echo $msg;?></div>
             
    <div class="form-group">
      <label class="control-label col-sm-3"> Edit Work Category </label>
      <div class="col-sm-4">
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/collcategory/<?php echo $row[photo];?>" width="120" height="120" class="img" />
