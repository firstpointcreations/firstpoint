...
$sql = "insert productcategory set name = '$titlename', pages = '$newname', photo2 = '$photo_namenew12', optionallink = '$optionallink', tagname = '$tagname', brief = '$brief', pageorder = '$pageorder', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
$exe = mysql_query($sql);

if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Service Category Successfully Submitted</b><br><br>";
//include('service_upload.php');
 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Service Category Not Submitted</b><br><br>"; 
 }
}
...
$sql = "insert productcategory set name = '$titlename', pages = '$newname', optionallink = '$optionallink', photo2 = '$photo_namenew12', tagname = '$tagname', brief = '$brief', pageorder = '$pageorder', photo = '$photo_namenew', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
$exe = mysql_query($sql);
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Products Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Service Category</label>
      <div class="col-sm-4">
