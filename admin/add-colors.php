...
$sqlchks = "select pages from colorscategory where pages = '$newname'";
...
$sql = "insert colorscategory set name = '$titlename', pages = '$newname', colorcode = '$colorcode', pageorder = '$pageorder', status = '$status', date=Now()";
$exe = mysql_query($sql);
...
$sql = "insert colorscategory set name = '$titlename', pages = '$newname', photo = '$photo_namenew', colorcode = '$colorcode', pageorder = '$pageorder', status = '$status', date=Now()";
$exe = mysql_query($sql);
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Colors</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Colors</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="colorcode" id="colorcode" required> (Example: - #cc0000)
      </div>
    </div>
