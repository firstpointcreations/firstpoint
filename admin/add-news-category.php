...
$sqlchks = "select pages from newscategory where pages = '$newname'";
...
$sql = "insert newscategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', status = '$status', date=Now()";
$exe = mysql_query($sql);
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add News Category</label>
      <div class="col-sm-4">
