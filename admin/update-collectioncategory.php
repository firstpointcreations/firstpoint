...
$sqlchks = "select pages from collcategory where pages = '".$_POST['pages']."'";
...
$sql = "update collcategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', status = '$status', date=Now() where id='$id'";
$exe = mysql_query($sql);



$sql4 = "update servicepages set fname = '$titlename', link = '$newname' where fname='$oldname'";
$exe4 = mysql_query($sql4);


if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Work Category Successfully Submitted</b><br><br>";
include('edit-collectioncategory.php');
 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Work Category Not Submitted</b><br><br>";
	include('edit-collectioncategory.php'); 
 }
...
$sql = "update collcategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', status = '$status', photo = '$photo_namenew', date=Now() where id='$id'";
$exe = mysql_query($sql);
