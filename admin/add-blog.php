...
$sqlchk = "select name from blogpages where name = '$titlename'";
...
$sqlchks = "select pages from blogpages where pages = '$newname'";
...
$sql = "insert blogpages set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', date=Now()";
	$exe = mysql_query($sql);


if(!$exe)
$msg="Error in Sql";
$msg="<br><b>Congratulation!! Your $titlename - Blog Page Successfully Submitted</b><br><br>";
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert blogpages set name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', date=Now()";
	$exe = mysql_query($sql);
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Blog Photo</label>
      <div class="col-sm-10">
