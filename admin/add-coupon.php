...
$sql = "insert couponpages set couponname = '$couponname', couponcode = '$couponcode', startdate = '$startdate', enddate = '$enddate', coupontype = '$coupontype', fixedamount = '$fixedamount', percentamount = '$percentamount', numbertimes = '$numbertimes', usetimes = '0', status = '$status', date=Now()";
$exe = mysql_query($sql);

if($exe)
{
$msg="<br><b>Congratulation!! Your $couponname - Coupons Successfully Submitted</b><br><br>";
...
<script type="text/javascript">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="<?php echo $PHP_SELF;?>" name="couponscategory">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" id="startdate" name="startdate" placeholder='DD-MM-YYYY' onKeyUp="if (/[^\d-]/g.test(this.value)) this.value = this.value.replace(/[^\d-]/g,'')" class="form-control" required onChange="validate(this)"/>
	...
	<div class="form-group">
      ...
      <div class="col-sm-4">
         <input type="text" id="enddate" name="enddate" placeholder='DD-MM-YYYY' onKeyUp="if (/[^\d-]/g.test(this.value)) this.value = this.value.replace(/[^\d-]/g,'')" class="form-control" required onChange="validate2(this)"/>
	...
	<div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" name="fixedamount" id="fixedamount">
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" name="percentamount" id="percentamount">
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="number" class="form-control" name="numbertimes" id="numbertimes" required>
      </div>
    </div> 
