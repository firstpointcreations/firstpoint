...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from pricelist where id='$id'");
?>
...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="update-price.php?id=<?php echo $row['id'];?>" name="samplescategory">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="price1" id="price1" value="<?php echo $row['price1'];?>" required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" name="price2" id="price2" value="<?php echo $row['price2'];?>" required>
