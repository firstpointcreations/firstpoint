...
if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Work Page Successfully Submitted</b><br><br>";
//include('service_upload.php');
}
else
{
$msg="<br><b>Sorry!! Your $titlename - Work Page Not Submitted</b><br><br>";
//include('service_upload.php');	
}
...
unlink("uploads/".$photo_namenew);
	...
	$sql = "insert servicepages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', photo = '$photo_namenew', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', imgstatus = '$imgstatus', fservice = '$fservice', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
	$exe = mysql_query($sql);
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
	...
	<div class="msgpass"><?php echo $msg;?></div>
      ...
      <div class="col-sm-4">
       <select class="form-control" name="fname" id="fname" required>
		 ...
		 <?php 
				  $sql="select *from collcategory where status='Active' order by pageorder asc";
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" >Work Name</label>
      <div class="col-sm-10">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Work Photo</label>
      <div class="col-sm-10">
