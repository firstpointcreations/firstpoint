...
$sql = "insert productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', brief = '$brief', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
$exe = mysql_query($sql);

if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Service Sub Category Successfully Submitted</b><br><br>";
//include('service_upload.php');
 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Service Sub Category Not Submitted</b><br><br>"; 
 }
...
$sql = "insert productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', photo = '$photo_namenew', brief = '$brief', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now()";
$exe = mysql_query($sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Service Sub Category</a></li>
...
while($rowp=mysql_fetch_array($queryp))
{
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Service Sub Category</label>
      <div class="col-sm-4">
