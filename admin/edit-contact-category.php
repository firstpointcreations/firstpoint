...
$sqlchks = "select pages from contactcategory where pages = '".$_POST['pages']."'";
...
$sql = "update contactcategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', status = '$status', phone = '$phone', web = '$web', address = '$address', email = '$email', facebook = '$facebook', twitter = '$twitter', youtube = '$youtube', instagram = '$instagram', googleplus = '$googleplus', linkedin = '$linkedin', whatsapp = '$whatsapp' where id='$id'";
$exe = mysql_query($sql);
