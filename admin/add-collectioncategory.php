...
$sqlchk = "select name from collcategory where name = '$titlename'";
...
$sqlchks = "select pages from collcategory where pages = '$newname'";
...
if($photo_name == "")
{
$sql = "insert collcategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', status = '$status', date=Now()";
$exe = mysql_query($sql);

if($exe)
{
$msg="<br><b>Congratulation!! Your $titlename - Collection Successfully Submitted</b><br><br>";
//include('service_upload.php');
 } 
 else
 {
	$msg="<br><b>Sorry!! Your $titlename - Collection Not Submitted</b><br><br>"; 
 }
...
$sql = "insert collcategory set name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', status = '$status', photo = '$photo_namenew', date=Now()";
$exe = mysql_query($sql);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Work Category </li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Work Category </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Work Category </label>
      <div class="col-sm-4">
