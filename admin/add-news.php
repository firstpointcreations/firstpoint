...
$sql = "insert newspages set fname = '$fname', link = '$link', name = '$titlename', pages = '$newname', pageorder = '$pageorder', brief = '$brief', cbrief = '$cbrief', metatoptitle = '$metatoptitle', metadescription = '$metadescription', metakeywords = '$metakeywords', todayhalfmonth='$todayhalfmonth', todayfullmonth='$todayfullmonth', todaydate='$todaydate', todayyear='$todayyear', date='$date', postdate=Now()";
	$exe = mysql_query($sql);
