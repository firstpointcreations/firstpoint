...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from faqpages where id='$id'");
?>
...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
 ...
 <form class="form-horizontal" method="Post" action="update-faq.php?id=<?php echo $row['id'];?>" name="donation" enctype="multipart/form-data" onsubmit="return valid_donation();">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Faq Details</label>
      <div class="col-sm-10">
