...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from colorscategory where id='$id'");
?>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Colors</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Colors</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="update-colors.php?id=<?php echo $row['id'];?>" name="samplescategory" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label class="control-label col-sm-3"> Colors</label>
      <div class="col-sm-4">
     ...
     <div class="form-group">
      <label class="control-label col-sm-3" > Colors Code </label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="colorcode" id="colorcode" value="<?php echo $row['colorcode'];?>" required> (Example: - #cc0000)
      </div>
    </div>
    
    <!--
     <div class="form-group">
      <label class="control-label col-sm-3" >Color Photo</label>
      <div class="col-sm-4">
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/colors/<?php echo $row[photo];?>" width="120" height="120" class="img" />
