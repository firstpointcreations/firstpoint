...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from productchildcategory where id='$id'");
?>
...
$sqlchks = "select childpages from productchildcategory where childpages = '".$_POST['childpages']."'";
...
$sql = "update productchildcategory set childname = '$titlename', childpages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', fname = '$productsubname', pages = '$pages', pcid = '$productsubid', pageorder = '$pageorder', brief = '$brief', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now() where id='$id'";
$exe = mysql_query($sql);

$sql2 = "update productspages set childname = '$titlename', childpages = '$newname' where childname='$oldname'";
$exe2 = mysql_query($sql2);

if($exe)
{
echo "<script>alert('Congratulation!! Your $titlename - Service Child Category Successfully Submitted')</script>";
echo  "<script>"; 
...
$myfile="uploads/products-childcategory/$del";
...
$sql = "update productchildcategory set childname = '$titlename', childpages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', fname = '$productsubname', pages = '$pages', pcid = '$productsubid', pageorder = '$pageorder', photo = '$photo_namenew', brief = '$brief', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now() where id='$id'";
$exe = mysql_query($sql);
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Service Child Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="edit-child-productcategory.php?id=<?php echo $id;?>" name="samplescategory" enctype="multipart/form-data">
      ...
      <div class="col-sm-4">
       ...
       <option value="">Select Product Category</option>
        ...
        <?php
$sql2="select * from productcategory where status='Active' order by pageorder asc";
$query2=mysql_query($sql2);
while($rowp=mysql_fetch_array($query2))
{
	?>			
      ...
      <div class="col-sm-4">
       ...
       <option value="<?php echo $row[pcid];?>" selected="selected"><?php echo $row[fname];?></option>
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Service Child Category</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="childname" id="childname" value="<?php echo $row['childname'];?>" required>
         <input type="hidden" class="form-control" name="oldname" id="oldname" value="<?php echo $row['childname'];?>">
        <input type="hidden" class="form-control" name="childpages" id="childpages" value="<?php echo $row['childpages'];?>">
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Service Photo</label>
      <div class="col-sm-4">
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/products-childcategory/<?php echo $row[photo];?>" width="120" height="120" class="img" />
