...
$sqlchks = "select pages from addcategory where pages = '".$_POST['pages']."'";
...
$sql = "update addcategory set name = '$titlename', pages = '$newname', boticon = '$boticon', pageorder = '$pageorder', brief = '$brief', status = '$status', frontstatus = '$frontstatus', date=Now() where id='$id'";
$exe = mysql_query($sql);


$sql3 = "update subcategory set fname = '$titlename', link = '$newname' where fname='$oldname'";
$exe3 = mysql_query($sql3);

$sql4 = "update projectpages set pcname = '$titlename', pclink = '$newname' where pcname='$oldname'";
...
$sql = "update addcategory set name = '$titlename', pages = '$newname', boticon = '$boticon', pageorder = '$pageorder', brief = '$brief', status = '$status', frontstatus = '$frontstatus', photo = '$photo_namenew', date=Now() where id='$id'";
$exe = mysql_query($sql);
