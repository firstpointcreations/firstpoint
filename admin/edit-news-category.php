...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from newscategory where id='$id'");
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="update-news-category.php?id=<?php echo $row['id'];?>" name="samplescategory">
              
              <div class="msgpass"><?php echo $msg;?></div>
             
    <div class="form-group">
      <label class="control-label col-sm-3"> News Category </label>
      <div class="col-sm-4">
