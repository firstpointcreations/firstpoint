...
<?php
$id = $_GET['id'];
$result = mysql_query("Select *from subcategory where id='$id'");
?>
...
?>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-10 col-md-offset-1">
              <form class="form-horizontal" method="post" action="update-sub-category.php?id=<?php echo $row['id'];?>" name="gallerycategory" enctype="multipart/form-data">
      ...
      <div class="col-sm-4">
       <select class="form-control" name="fname" id="fname" required>
		 ...
		 <?php 
				  $sqlp="select *from addcategory where status='Active' order by pageorder asc";
  ...
  ?>
						...
						<img src="<?php echo $urlroot;?>admin/uploads/sub-category/<?php echo $row[photo];?>" width="120" height="120" class="img" />
