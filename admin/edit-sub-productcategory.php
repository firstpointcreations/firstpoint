...
$sql = "update productsubcategory set fname = '$titlename', pages = '$newname', optionallink = '$optionallink', name = '$productname', link = '$link', pid = '$productid', pageorder = '$pageorder', photo = '$photo_namenew', brief = '$brief', status = '$status', metatoptitle = '$metatoptitle', metakeywords = '$metakeywords', metadescription = '$metadescription', date=Now() where id='$id'";
$exe = mysql_query($sql);
...
echo "<script>alert('Congratulation!! Your $titlename - Service Sub Category Successfully Submitted')</script>";
echo  "<script>"; 
 ...
 {
	echo "<script>alert('Your $titlename - Service Sub Category Not Successfully Submitted')</script>"; 
	echo  "<script>"; 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Product Sub Category</a></li>
        <li class="active">Edit Product Sub Category</li>
      </ol>
    </section>
...
while($rowp=mysql_fetch_array($query))
{
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Add Product Sub Category</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" >Product Photo</label>
      <div class="col-sm-4">
